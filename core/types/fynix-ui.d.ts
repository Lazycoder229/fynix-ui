// Enhanced type exports for @fynixorg/ui
// This file provides better IntelliSense support
...
declare module '@fynixorg/ui' {
   ...
   */
  export function nixStore<T extends Record<string, any>>(initialState: T): NixStore<T>;
   ...
   */
  export function nixRef<T = any>(initialValue?: T): {
    current: T;
  };
   ...
   */
  export function nixLazyAsync<T>(
    loader: () => Promise<T>
  ): NixAsyncResult<T>;
